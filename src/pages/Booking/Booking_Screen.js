...
import fontStyle from "../../shared/styles/font.global.style";
...
export default function Booking_Screen({ route }) {
  ...
  const removeItemFromSelectedLayanan = (id) => {
    setSelectedLayanan((prevLayanan) =>
      prevLayanan.filter((item) => item.id !== id)
    );
  };
  const toggleModal = () => {
                      ...
                      >
                        ...
                        <View style={styles.ketegoriBox_Right}>
                          <TouchableOpacity
                            ...
                            onPress={() =>
                              removeItemFromSelectedLayanan(item.id)
                            }
                          >
                            <Image
                  ...
                  <View key={index} style={{ ...styles.SpesialisStyle }}>
                    <TouchableOpacity
                      style={{
                        ...
                        borderColor:
                          item.isFocused == true ? COLORS.purple : COLORS.grey,
                        borderWidth:
                          item.isFocused == true ? responsiveScreenWidth(1) : 0,
                      }}
                    >
                      <Image
                        source={item.icon}
                  ...
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      borderColor:
                        item.isFocused == true ? COLORS.purple : COLORS.grey,
                      backgroundColor:
                        item.isFocused == true ? COLORS.blue_bg : COLORS.white,
                    }}
                  >
                    <Text
                      style={
        ...
        <View style={styles.FloatingBottomContainer}>
          <View style={styles.FloatingBottomLeft}>
            <Text style={fontStyle.Manrope_Bold_14}>
              Total{" "}
              <Text style={fontStyle.NunitoSans_Regular_14}>(4 Layanan)</Text>
            </Text>
            <Text
          ...
          <View style={styles.FloatingBottomRight}>
            <ButtonPurple
              ...
              title={"Booking"}
              ButtonHeight={55}
              onPress={() => navigation.navigate("BookingCheckout_Screen")}
            />
          </View>
        </View>
      </View>
